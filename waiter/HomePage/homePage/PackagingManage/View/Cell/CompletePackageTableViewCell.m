//
//  CompletePackageTableViewCell.m
//  waiter
//
...
#import "Header.h"
#define FONTSIZE 15
@implementation CompletePackageTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        //5.实际取餐时间行
        UILabel * actuallyPickUpTime = [[UILabel alloc]init];
        actuallyPickUpTime.text = @"";
        actuallyPickUpTime.font = [UIFont systemFontOfSize:FONTSIZE];
        _actuallyPickUpTime = actuallyPickUpTime;
        [_grayBackground addSubview:_actuallyPickUpTime];
...
- (void)layoutSubviews{
    ...
    _actuallyPickUpTime.frame = CGRectMake(10, rowHeight*3, rowWidth, rowHeight);
    _guest.frame = CGRectMake(10, rowHeight*4, rowWidth, rowHeight);
